  ...
  return (
    <AdminShell title="داشبورد" description="نمایی روشن از وضعیت فروشگاه و کارهای امروز.">
      <div className="admin-dashboard-head">
        <div><span className="admin-live-dot" /> وضعیت فروشگاه: فعال</div>
      ...
      <section className="admin-dashboard-columns">
        ...
        <div className="admin-card admin-health-card"><div className="admin-section-head"><div><h2 className="admin-section-title">وضعیت فروشگاه</h2><p className="admin-section-note">بررسی سریع سیستم</p></div><span className="admin-health-ok">● عادی</span></div><div className="admin-health-list"><div><span>درگاه پرداخت</span><strong>فعال</strong></div><div><span>ارسال پیامک</span><strong>فعال</strong></div><div><span>فضای ذخیره‌سازی</span><strong>۶۳٪</strong></div><div className="admin-progress"><span /><i /></div><div><span>آخرین پشتیبان‌گیری</span><small>امروز، ۰۲:۳۰</small></div><div><span>نسخه سیستم</span><small>v2.4.1</small></div></div></div>
      </section>
      ...
      <section className="admin-lower-grid">
        ...
        <div className="admin-card"><div className="admin-section-head"><div><h2 className="admin-section-title">هشدارها و اطلاعیه‌ها</h2><p className="admin-section-note">مواردی که نیاز به توجه دارند</p></div><span className="admin-notification-count">۳</span></div><div className="admin-alerts"><div className="admin-alert danger"><b><AdminIcon name="products" size={15} /></b><span>موجودی ۵ محصول رو به پایان است.</span><small>۲ ساعت پیش</small></div><div className="admin-alert warning"><b><AdminIcon name="orders" size={15} /></b><span>{pending || 3} سفارش در انتظار پرداخت می‌باشد.</span><small>۵ ساعت پیش</small></div><div className="admin-alert info"><b><AdminIcon name="sparkles" size={15} /></b><span>نسخه جدید پنل مدیریت منتشر شد.</span><small>دیروز</small></div></div></div>
      </section>
