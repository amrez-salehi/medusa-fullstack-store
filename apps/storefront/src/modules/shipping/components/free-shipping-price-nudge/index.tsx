...
function FreeShippingInline({
  ...
  return (
    <div className="border border-[var(--color-border)] bg-[var(--color-light-cream)] p-2">
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      ...
      <div className="w-[400px] bg-[var(--color-ink)] p-6 text-white">
        <div className="pb-4">
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="border border-white bg-transparent px-4 py-2.5 text-[15px] shadow-none outline-none"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow border border-white bg-white px-4 py-2.5 text-center text-[15px] text-neutral-950 shadow-none outline-none"
            href="/store"
          >
            View products
          </LocalizedClientLink>
